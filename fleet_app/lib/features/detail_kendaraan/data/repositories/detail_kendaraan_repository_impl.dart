...
class DetailKendaraanRepositoryImpl implements DetailKendaraanRepository {
  ...
  @override
  Future<DetailKendaraanEntity> update({required int id, String? noPolisi, String? namaPemilik, String? berlakuMulai, XFile? fotoStnk, XFile? fotoBpkb, XFile? fotoNomor, XFile? fotoKm}) async {
    try {
