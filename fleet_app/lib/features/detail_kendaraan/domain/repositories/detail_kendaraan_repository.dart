...
abstract class DetailKendaraanRepository {
  ...
  Future<DetailKendaraanEntity> update({required int id, String? noPolisi, String? namaPemilik, String? berlakuMulai, XFile? fotoStnk, XFile? fotoBpkb, XFile? fotoNomor, XFile? fotoKm});
