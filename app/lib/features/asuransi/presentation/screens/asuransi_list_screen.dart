    ...
    return PopScope(
      ...
      child: Scaffold(
                        ...
                        sliver: SliverList(
                          delegate: SliverChildBuilderDelegate(
                            (_, i) {
                              ...
                              final akhir =
                                  DateTime.tryParse(item.tanggalAkhir);
                              final isActive =
                                  akhir != null && akhir.isAfter(now);
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          IconButton(
                                            ...
                                            onPressed: () async {
                                              await ctx.push(
                                                  '/asuransi/${item.id}/edit',
                                                  extra: item);
                                              if (ctx.mounted)
                                                ctx
                                                    .read<AsuransiBloc>()
                                                    .add(AsuransiLoadRequested(
                                                        kendaraanId: widget
                                                            .kendaraanId));
                                            },
                                            padding:
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            await context.push('/asuransi/create',
